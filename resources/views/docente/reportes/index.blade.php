...
@section('content_header')
    <h1><b>Mis Reportes Académicos</b></h1>
    <hr>
@stop
...
@section('content')
                                ...
                                <div class="modal fade" id="editReporteModal{{ $reporte->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('docente.reportes.update', $reporte->id) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="promedio_general" class="form-control" step="0.01" min="0" max="20"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="porcentaje_asistencia" class="form-control" step="0.01" min="0" max="100"
    ...
    <!-- Modal Crear -->
    <div class="modal fade" id="createReporteModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('docente.reportes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <strong>Tip:</strong> Puedes dejar el promedio y asistencia en blanco, se calcularán automáticamente al guardar el reporte.
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="visible_tutor_create"
                                            name="visible_tutor_create" value="1" {{ old('visible_tutor_create') ? 'checked' : '' }}>
