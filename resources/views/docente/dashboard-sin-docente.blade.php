...
@section('title', 'Perfil No Asignado')
...
<div class="d2-page" style="display:flex;align-items:center;justify-content:center;min-height:80vh">
    <div class="d2-state-card">

        <div class="d2-state-card__orb d2-state-card__orb--amber">
            <i class="fas fa-chalkboard-teacher" style="color:var(--d-amber)"></i>
        </div>

        <h2 class="d2-state-card__title">Perfil de Docente no Asignado</h2>
        <p class="d2-state-card__sub">
            Tu cuenta tiene el rol de docente, pero aun no se ha creado ni vinculado tu perfil de docente en el sistema.
        </p>

        <ul class="d2-steps">
            <li>
                <div class="d2-steps__num d2-steps__num--amber">1</div>
                <span>Crear tu perfil de docente en el modulo de docentes</span>
            </li>
            <li>
                <div class="d2-steps__num d2-steps__num--amber">2</div>
                <span>Vincular tu perfil de persona con el perfil de docente</span>
            </li>
            <li>
                <div class="d2-steps__num d2-steps__num--amber">3</div>
                <span>Asignar cursos y grados a tu cargo</span>
            </li>
        </ul>

        <div class="d2-user-pill">
            <i class="fas fa-user" style="color:var(--d-brand)"></i>
