            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-gradient-danger">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" style="font-size: 1.5rem;">
                                        @if($reporte->tienePdf())
                                            <a href="{{ route('tutor.reportes.descargar-pdf', $reporte->id) }}" class="text-white">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="{{ route('tutor.reportes.index') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i> Volver al Listado
                                </a>
                                @if($reporte->tienePdf())
                                <a href="{{ route('tutor.reportes.descargar-pdf', $reporte->id) }}" class="btn btn-danger">
